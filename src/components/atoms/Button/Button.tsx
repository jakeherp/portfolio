...
const Button: FC<PropsWithChildren<ButtonProps>> = (props) => {
	...
	const classes =
		'rounded-md bg-blue-700 hover:bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600';
